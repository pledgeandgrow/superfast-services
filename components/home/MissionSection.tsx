...
export default function MissionSection() {
  ...
  return (
    <section className="py-24 md:py-32 bg-white" id="mission">
      <div className="mx-auto max-w-7xl px-6 lg:px-12">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-white border border-gray-200 p-8 md:p-12 rounded-3xl shadow-xl mb-12">
            <p className="text-xl text-gray-600 leading-relaxed mb-8">
              <span className="font-bold text-blue-600 text-2xl">&quot;Name it, We do it&quot;</span> — En quelques mots : ce que vous cherchez nous le trouvons. En étant VOTRE représentant chez vos fournisseurs, nous nous engageons à vous apporter notre assistance et notre expertise en toute transparence et un accompagnement sur mesure tout au long du processus d&apos;approvisionnement.
            </p>

            {/* Quote */}
            <div className="relative bg-gradient-to-br from-blue-50 to-indigo-50 p-8 rounded-2xl border-l-4 border-blue-600">
              <Quote className="absolute top-6 left-6 w-10 h-10 text-blue-600/20" />
              <p className="text-gray-600 italic leading-relaxed mb-6 pl-8">
              ...
              <p className="font-bold text-gray-900 pl-8">— Ahmed Salah, Directeur Général</p>
            </div>
          </motion.div>
